...
public class DashboardGUI extends JFrame {
    ...
    private JPanel buildSidebar() {
        ...
        javax.swing.ImageIcon[] menuIcons = {
            IconFactory.home(18, Color.WHITE),  IconFactory.book(18, Color.WHITE),
            IconFactory.list(18, Color.WHITE),  IconFactory.target(18, Color.WHITE),
            IconFactory.chart(18, Color.WHITE), IconFactory.stats(18, Color.WHITE)
        };

        for (int i = 0; i < menuLabels.length; i++) {
            menuButtons[i] = createSidebarBtn(menuLabels[i], i == 0);
            menuButtons[i].setIcon(menuIcons[i]);
            menuButtons[i].setIconTextGap(12);
            int idx = i;
